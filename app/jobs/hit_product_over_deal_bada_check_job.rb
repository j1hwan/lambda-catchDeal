## 딜바다 사이트에 대해 기존의 크롤링/데이터 생성 목차의 다음 목차부터 크롤링이 수행됩니다.
# HitProductOverDealBadaCheckJob.perform_now(:main_deal_bada_check_data_chrome)

class HitProductOverDealBadaCheckJob < ApplicationJob
